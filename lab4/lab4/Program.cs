...
/*
 * Створити суперклас Навчальний заклад і підкласи Школа, Університет, Факультет.
 * За допомогою конструктора задати кількість учнів у закладі.Визначити кількість
 * викладачів у навчальному закладі, кількість класів у школі та рік заснування 
 * факультету. Вивести на екран кількість факультетів в університеті.
 */
